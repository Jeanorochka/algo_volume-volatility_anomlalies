...
учитывается спред
06.12.2025
теперь торгует минутные свечи (можно подправить под ваш диапазон в мейне -- не проблема), выходит не по энтрипрайс, а по текущей т.е внутри свечи по касании тпсл будет закрываться поза. 
